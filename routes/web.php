...
//            Route::delete('suppliers/{supplier}', 'Tenant\SupplierController@destroy');
            ...
            Route::get('documents/search/alumnos', 'Tenant\DocumentController@searchAlumnos');
            Route::get('documents/search/alumno/{id}', 'Tenant\DocumentController@searchAlumnoById');
            Route::get('documents/search/vendedores', 'Tenant\DocumentController@searchVendedores');
            Route::get('documents/search/vendedor/{id}', 'Tenant\DocumentController@searchVendedorById');
...
//            Route::get('voided/ticket/{voided_id}/{group_id}', 'Tenant\VoidedController@ticket');
            ...
            Route::get('reports/comisiones', 'Tenant\ReportComisionesController@index')->name('tenant.reports.comisiones.index');
            Route::get('reports/comisiones/search', 'Tenant\ReportComisionesController@search')->name('tenant.reports.comisiones.search');
            Route::post('reports/comisiones/pdf', 'Tenant\ReportComisionesController@pdf')->name('tenant.report.comisiones.report_pdf');
            Route::post('reports/comisiones/excel', 'Tenant\ReportComisionesController@excel')->name('tenant.report.comisiones.report_excel');

            Route::get('reports/caja', 'Tenant\ReportCajaController@index')->name('tenant.reports.caja.index');
            Route::get('reports/caja/search', 'Tenant\ReportCajaController@search')->name('tenant.reports.caja.search');
            Route::post('reports/caja/pdf', 'Tenant\ReportCajaController@pdf')->name('tenant.report.caja.report_pdf');
            Route::post('reports/caja/excel', 'Tenant\ReportCajaController@excel')->name('tenant.report.caja.report_excel');
...
//            Route::post('reports/kardex/excel', 'Tenant\ReportKardexController@excel')->name('tenant.report.kardex.report_excel');
            ...
            //egreso-caja
            Route::get('egreso-caja', 'Tenant\EgresoCajaController@index')->name('tenant.egreso_caja.index');

            Route::get('egreso-caja/record/{egreso}', 'Tenant\EgresoCajaController@record');
            Route::get('egreso-caja/create', 'Tenant\EgresoCajaController@create');
            Route::get('egreso-caja/tables', 'Tenant\EgresoCajaController@tables');
            Route::get('egreso-caja/records', 'Tenant\EgresoCajaController@records');
            Route::post('egreso-caja', 'Tenant\EgresoCajaController@store');
            Route::delete('egreso-caja/{egreso}', 'Tenant\EgresoCajaController@destroy');
            ...
            Route::get('sale-notes/search/alumnos', 'Tenant\SaleNoteController@searchAlumnos');
            Route::get('sale-notes/search/alumno/{id}', 'Tenant\SaleNoteController@searchAlumnoById');
            Route::get('sale-notes/search/vendedores', 'Tenant\SaleNoteController@searchVendedores');
            Route::get('sale-notes/search/vendedor/{id}', 'Tenant\SaleNoteController@searchVendedorById');
    ...
    Route::domain(env('APP_URL_BASE'))->group(function() {
        ...
        Route::middleware('auth:admin')->group(function() {
            ...
            //Reportes
            Route::get('reportes', 'System\ReportController@index')->name('system.reportes.index');
            Route::get('reportes/search', 'System\ReportController@search')->name('system.reportes.search');
            Route::post('reportes/pdf', 'System\ReportController@pdf')->name('system.report_pdf');
            Route::post('reportes/excel', 'System\ReportController@excel')->name('system.report_excel');

            //Reportes Caja
            Route::get('caja', 'System\CajaController@index')->name('system.caja.index');
            Route::get('caja/search', 'System\CajaController@search')->name('system.caja.search');
            Route::post('caja/pdf', 'System\CajaController@pdf')->name('system.report_pdf');
            Route::post('caja/excel', 'System\CajaController@excel')->name('system.report_excel');


            //Reportes Comisiones
            Route::get('comisiones', 'System\ComisionesController@index')->name('system.comisiones.index');
            Route::get('comisiones/search', 'System\ComisionesController@search')->name('system.comisiones.search');
            Route::post('comisiones/pdf', 'System\ComisionesController@pdf')->name('system.report_pdf');
            Route::post('comisiones/excel', 'System\ComisionesController@excel')->name('system.report_excel');
