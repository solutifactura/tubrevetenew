...
class DocumentTest extends DuskTestCase
{
    ...
    */
    ...
    public function ticket($browser){
        ...
        $browser->click('@alumno_id')
                ->waitFor('@alumno_id')
                ->elements('.el-select-alumnos .el-select-dropdown__item')[0]->click();

        $browser->click('@vendedor_id')
                ->waitFor('@vendedor_id')
                ->elements('.el-select-vendedores .el-select-dropdown__item')[0]->click();
