            ...
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    ...
                    <li class="
                        ...
                        {{ ($path[0] === 'persons' && $path[1] === 'alumnos')?'nav-active nav-expanded':'' }}
                        ...
                        {{ ($path[0] === 'egreso-caja')?'nav-active nav-expanded':'' }}
                        ...
                        <ul class="nav nav-children" style="">
                            ...
                            <li class="{{ ($path[0] === 'persons' && $path[1] === 'alumnos')?'nav-active':'' }}">
                                <a class="nav-link" href="{{route('tenant.persons.index', ['type' => 'alumnos'])}}">
                                    Alumnos
                                </a>
                            </li>
                            ...
                            <li class="{{ ($path[0] === 'egreso-caja')?'nav-active':'' }}">
                                <a class="nav-link" href="{{route('tenant.egreso_caja.index')}}">
                                Egresos de Caja
                                </a>
                            </li>
                            {{-- <li class="#">
                    ...
                    {{ ($path[0] === 'persons' && $path[1] === 'Vendedores')?'nav-active nav-expanded':'' }}
                    ">
                        <a class="nav-link" href="#">
                        ...
                        <ul class="nav nav-children" style="">
                            ...
                            <li class="{{ ($path[0] === 'persons' && $path[1] === 'vendedores')?'nav-active':'' }}">
                                <a class="nav-link" href="{{route('tenant.persons.index', ['type' => 'vendedores'])}}">
                                Promotores
                                </a>
                            </li>
                    ...
                    <li class="nav-parent {{  ($path[0] === 'reports' && in_array($path[1], ['purchases', 'search','comisiones','caja',''])) ? 'nav-active nav-expanded' : ''}}">
                        <a class="nav-link" href="#">
                        ...
                        <ul class="nav nav-children" style="">
                            ...
                            <li class="{{(($path[0] === 'reports') && ($path[1] === 'comisiones')) ? 'nav-active' : ''}}">
                                <a class="nav-link" href="{{route('tenant.reports.comisiones.index')}}">
                                    Comisiones
                                </a>
                            </li>
                            <li class="{{(($path[0] === 'reports') && ($path[1] === 'caja')) ? 'nav-active' : ''}}">
                                <a class="nav-link" href="{{route('tenant.reports.caja.index')}}">
                                    Cierre de Caja
                                </a>
                            </li>
