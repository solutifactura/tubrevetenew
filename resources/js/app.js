...
Vue.component('tenant-egreso-caja-index', require('./views/tenant/egreso_caja/index.vue'));
Vue.component('tenant-egreso-caja-form', require('./views/tenant/egreso_caja/form.vue'));
...
Vue.component('system-calendar', require('./views/system/components/calendar.vue'));
