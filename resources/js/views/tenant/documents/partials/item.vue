                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="form-group" :class="{'has-danger': errors.comision_value}">
                            ...
                            <el-input v-model="form.comision_value" @input="calculateQuantity" :readonly="user.type === 'seller'">
                                <template slot="prepend" v-if="form.item.currency_type_symbol">{{ form.item.currency_type_symbol }}</template>
                            </el-input>
...
//                this.categories = response.categories
        ...
        methods: {
            ...
            clickAddItem() {
                ...
                this.form.unit_price = _.round(unit_price, 2);
                this.form.item.unit_price = _.round(unit_price, 2);
