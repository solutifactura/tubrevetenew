        ...
        methods: {
            ...
            searchRemoteAlumnos(input) {  
                ...
                // if (input!="") {
                    ...
                    let parameters = `input=${input}&document_type_id=03&operation_type_id=${this.form.operation_type_id}`
                    ...
                    this.$http.get(`/${this.resource}/search/alumnos?${parameters}`)
                            .then(response => { 
                                ...
                                if(this.alumnos.length == 0){this.filterAlumnos()}
                            })  
                } else {
                    // this.customers = []
                    this.filterAlumnos()
                   ...
                   let parameters = `input=${input}&document_type_id=03&operation_type_id=${this.form.operation_type_id}`
                    ...
                    this.$http.get(`/${this.resource}/search/vendedores?${parameters}`)
                            .then(response => { 
                                ...
                                if(this.vendedores.length == 0){this.filterVendedores()}
                            })  
                } else {
                    // this.customers = []
            ...
            filterAlumnos() {
                // this.form.customer_id = null
                  ...
                  if(this.form.operation_type_id === '0101') {
                    if(this.form.document_type_id === '01') {
                        this.alumnos = _.filter(this.all_alumnos, {'identity_document_type_id': '6'})
                        
                         this.alumnos = null
                    } else {
                        if(this.document_type_03_filter) {
                            this.alumnos = _.filter(this.all_alumnos, (c) => { return c.identity_document_type_id !== '6' })
            ...
            filterVendedores() {
                ...
                if(this.form.operation_type_id === '0101') {
                    if(this.form.document_type_id === '01') {
                        this.vendedores = _.filter(this.all_vendedores, {'identity_document_type_id': '6'})
                        this.vendedores = null
                    } else {
                        if(this.document_type_03_filter) {
                            this.vendedores = _.filter(this.all_vendedores, (c) => { return c.identity_document_type_id !== '6' })
                        } else {
