...
class SaleNote extends ModelTenant
{
    ...
    public function getAlumnoAttribute($value)
    {
        return (is_null($value))?null:(object) json_decode($value);
    }
    ...
    public function setAlumnoAttribute($value)
    {
        $this->attributes['alumno'] = (is_null($value))?null:json_encode($value);
    }

    public function setVendedorAttribute($value)
    {
        $this->attributes['vendedor'] = (is_null($value))?null:json_encode($value);
    }
