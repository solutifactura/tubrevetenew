...
{   
    ...
    {   
        ...
        return view('system.reportes.index', compact('clients'));
    }

    public function create()
    {
        return view('system.reportes.form');
    }
    ...
    public function search(Request $request)
    {
        ...
        return view("system.reportes.index", compact("reports", "a", "d", "client","clients"));
    ...
    public function pdf(Request $request) {
        ...
        $pdf = PDF::loadView('system.reportes.report_pdf', compact("reports", "a", "d"));
