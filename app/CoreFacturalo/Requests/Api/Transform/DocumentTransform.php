...
//            'establishment' => EstablishmentTransform::transform($inputs['datos_del_emisor']),
            ...
            'alumno' => PersonTransform::transform($inputs['datos_del_alumno']),
            'vendedor' => PersonTransform::transform($inputs['datos_del_vendedor']),
            ...
            'total_comisiones' => Functions::valueKeyInArray($totals, 'total_comisiones'),
        ...
        if(key_exists('items', $inputs)) {
            ...
            foreach ($inputs['items'] as $row) {
                $items[] = [
                    ...
                    'total_comision' => Functions::valueKeyInArray($row, 'valor_comision'),
