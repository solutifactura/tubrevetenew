...
<table class="full-width">
    ...
    <tr>
        <td class="text-center pb-3 border-bottom"><h4>{{ $document_number }}</h4></td>
    </tr>
</table>
<table class="full-width">
    <tr>
    ...
    @if ($alumno !== '')
    <tr>
        <td class="align-top"><p class="desc">Alumno:</p></td>
        <td><p class="desc">{{ json_decode ($document->alumno)->name  }}</p></td>
    </tr>
